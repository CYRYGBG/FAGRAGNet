...
class FAGRAGNet(nn.Module):
	def __init__(self):
		...
		self.conv1 = Conv2d(1, 32, (3, 3), padding=(3 // 2, 3 // 2))
		self.drop1 = Dropout(drop_rate)
		self.pool1 = MaxPool2d((1, 4))
		self.RG1 = ResidualGraph(66 * 32 * 5, 64, 32, topk)

		self.conv2 = Conv2d(32, 32, (3, 3), padding=(3 // 2, 3 // 2))
		self.drop2 = Dropout(drop_rate)
		self.pool2 = MaxPool2d((1, 4), padding=(0, 2))
		self.RG2 = ResidualGraph(17 * 32 * 5, 64, 32, topk)

		self.conv3 = Conv2d(32, 32, (1, 3))
		self.drop3 = Dropout(drop_rate)
		self.pool3 = MaxPool2d((1, 2))
		self.RG3 = ResidualGraph(5 * 32 * 7, 64, 32, topk)

		self.conv4 = Conv2d(32, 64, (1, 3))
		self.drop4 = Dropout(drop_rate)
		self.pool4 = MaxPool2d((1, 2))
		self.RG4 = ResidualGraph(10 * 64, 64, 32, topk)

		self.conv5 = Conv2d(64, 128, (1, 2))
		self.drop5 = Dropout(drop_rate)
		# self.pool3 = MaxPool2d((1, 4))
		self.RG5 = ResidualGraph(5 * 128, 64, 32, topk)
